...
def parsering():
    ...
    # Model parameter
    parser.add_argument("--type", default="GHCN", help="model type.")
    parser.add_argument(
        "--hidden", type=int, default=64, help="Number of hidden units."
    )
    parser.add_argument("--k", type=int, default=10, help="Number of K of APPNP")
    parser.add_argument(
        "--dropout",
        type=float,
        default=0.5,
    ...
    parser.add_argument(
        "--withbn", action="store_true", default=False, help="Enable Bath Norm GCN"
    )
    parser.add_argument(
        "--nhiddenlayer", type=int, default=1, help="The number of hidden layers."
    )
    ...
    parser.add_argument(
        "--activate_dataset", type=str, default="none", help="The hgcn benchmark."
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help='Don"t using probability distance map',
    )
    parser.add_argument(
        "--gamma",
        type=float,
        default=0.5,
        help="Guass kernel flat coefficiency for constructing edge-dependent vertex weights",
    )
    parser.add_argument(
        "--on_dataset",
        type=str,
        default="NTU2012",
        help="select the dataset you use, ModelNet40 or NTU2012.",
    ...
    parser.add_argument(
        "--split", type=int, default=1, help="train-test split used for the dataset"
    )

    parser.add_argument("--save_file", default="results.csv", help="save file name")

    parser.add_argument(
        "--degree", type=int, default=16, help="degree of the approximation."
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="whether to use attention in phenomnn_s",
    )
    parser.add_argument("--tau", type=float, default=0.01, help="attention parameters.")
    parser.add_argument(
        "--attn_dropout", type=float, default=0, help="attention parameters."
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1,
        help="featurenoise for synthetic datasets",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="features",
        help="The encoding file to use for features (without .pkl extension).",
    )
